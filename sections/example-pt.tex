...
\begin{figure}[htb]
	...
	\end{center}
	\legend{Fonte: \cite[p. 13]{steuer1992defining}.}
	\label{fig_mitbih}
\end{figure}
...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State Atualiza a velocidade da partícula de acordo com \ref{eq:edge}
		\State Atualiza a posição da partícula usando \ref{eq:edge}
